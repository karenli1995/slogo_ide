...
//		return (TurtleSceneTab) this.getSelectionModel().getSelectedItem();
	...
	public void update(Observable o, Object arg) {
		...
		double newRotAngle = otherSlogoObj.getTurtleData(tabId).getTurtle(0).getRotationAngle();
		double newLocX = otherSlogoObj.getTurtleData(tabId).getTurtle(0).getTrail().getX();
		double newLocY = otherSlogoObj.getTurtleData(tabId).getTurtle(0).getTrail().getY();
