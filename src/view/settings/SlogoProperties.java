...
public class SlogoProperties {
  ...
  private static String[] myStartColors =
      { Color.ALICEBLUE.toString(), Color.PURPLE.toString(), Color.CADETBLUE.toString(),
        Color.AQUAMARINE.toString(),
        Color.AZURE.toString(),
        Color.GREEN.toString(), Color.DARKGREEN.toString(), Color.CHARTREUSE.toString(),
        Color.CORAL.toString(),
        Color.RED.toString(), Color.YELLOW.toString(),
        Color.DARKGOLDENROD.toString(), Color.DEEPPINK.toString(), Color.HOTPINK.toString(),
        Color.BROWN.toString(),
        Color.ROSYBROWN.toString(), Color.ORANGE.toString(),
        Color.ORCHID.toString(), Color.DARKORCHID.toString(), Color.BLACK.toString(),
        Color.BLANCHEDALMOND.toString(),
